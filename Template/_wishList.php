   ...
   <?php 
        //post method 
            if($_SERVER['REQUEST_METHOD'] == 'POST'){
                ...
                if(isset($_POST['move_from_wishlist_toCart'])){
                    $moveToCart = $cart->addToWhishlist($_POST['move_item_id'] , 'cart' , 'wishlist');
                }
            //     if(isset($_POST["delete_item_from_wishlist"])){
            //         $cart->deletefromCart($_POST['product_id'] , 'wishlist');
            //    }
            }
                                                ...
                                                <!-- product qty -->
                                                    <div class="qty d-flex pt-2">
                                                        ...
                                                        <form action="" method="post">
                                                            ...
                                                            <button type="submit" name="delete_item_from_wishlist" class="btn font-baloo text-danger px-3 border-right">Delete</button>
                                                        </form>


                                                        <form action="" method="post">
                                                            <input name = "move_item_id"  type="hidden" value = "<?php echo$cartProduct["item_id"] ?>">
                                                            <button type="submit" name="move_from_wishlist_toCart" class="btn font-baloo text-danger px-3 border-right">Add To Cart</button>
                                                        </form>
